        ...
        <div class="row">
            <div class="col-lg-4 mx-auto">
                <div class="xs-heading text-center">
                    <h2 class="section-subtitle"><?php echo $Pricing[0];?></h2>
                    <h3 class="section-title "><?php echo $Pricing[0];?></h3>
                </div><!-- .xs-heading END -->
            </div>
        </div><!-- .row END -->
        <div class="row">
            <div class="col-md-12 xs-pricing-group">
                <ul class="nav nav-tabs main-nav-tab tab-swipe wow fadeIn" role="tablist">
                    <li>
                        <a id="monthly-tab" class="active show" data-toggle="tab" href="#monthly" role="tab" aria-controls="monthly" aria-selected="true"><?php echo $Pricing[0];?></a>
                    </li>
                    <li>
                        <a id="yearly-tab" data-toggle="tab" href="#yearly" role="tab" aria-controls="yearly" aria-selected="false"><?php echo $Pricing[0];?></a>
                    </li>
                </ul>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="xs-single-pricing">
                                    <div class="pricing-header">
                                        <h3 class="xs-content-title"><?php echo $Pricing[0];?></h3>
                                        <div class="pricing-img-block">
                                            <img src="assets/images/pricing/pricing-1.png" alt="hostinza pricing image">
                                        </div>
                                        <h2 class="price-table"><sup><?php echo $Pricing[0];?></sup><?php echo $Pricing[0];?><sub><?php echo $Pricing[0];?></sub></h2>
                                    </div><!-- .pricing-header END -->
                                    <div class="pricing-body">
                                        <ul class="xs-list">
                                            <li><?php echo $Pricing[0];?></li>
                                            <li><?php echo $Pricing[0];?></li>
                                            <li><?php echo $Pricing[0];?></li>
                                            <li><?php echo $Pricing[0];?></li>
                                            <li><?php echo $Pricing[0];?></li>
                                    ...
                                    <div class="pricing-footer">
                                        <a href="#" class="btn btn-primary"><?php echo $Pricing[0];?></a>
